...
insertItem($conn, $userId, $idWork, $title, $urlFile, $nameFile, $capability, $extLink, $idManifestation, $note, $dayvisited, $monthvisited, $yearvisited, $idPeople, $idRespPeople, $idInstitut, $idRespInstit);
...
<p>Esemplare inserita correttamente</p>
