...
<p>Espressione eliminata correttamente</p>
<p>Attendi qualche secondo o clicca <a href="../../LevelsList/?level=expression">qui</a> per tornare indietro.</p>

     <script>
         setTimeout(function(){
            window.location.href = '../../LevelsList/?level=expression';
         }, 3000);
	</script>
