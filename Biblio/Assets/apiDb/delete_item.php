...
<p>Esemplare eliminato correttamente</p>
<p>Attendi qualche secondo o clicca <a href="../../LevelsList/?level=item">qui</a> per tornare indietro.</p>

     <script>
         setTimeout(function(){
            window.location.href = '../../LevelsList/?level=item';
         }, 3000);
	</script>
