...
if (empty($_POST['link'])){ 
	$link = "";
} else $link = mysqli_real_escape_string($conn,$_POST['link']);



updateInstitution($conn, $id, $name, $link);
...
<p>Istituzione modificata correttamente</p>
<p>Attendi qualche secondo o clicca <a href="../../Responsability/institution.php">qui</a> per tornare indietro.</p>

     <script>
         setTimeout(function(){
            window.location.href = '../../Responsability/institution.php';
         }, 3000);
	</script>
