...
$id= $_POST['idRespModify'];
$level= mysqli_real_escape_string($conn,$_POST['level']);
$name= mysqli_real_escape_string($conn,$_POST['name']);

updateResponsabilityType($conn, $id, $name, $level);
...
<p>Responsabilità modificata correttamente</p>
<p>Attendi qualche secondo o clicca <a href="../../">qui</a> per tornare indietro.</p>
