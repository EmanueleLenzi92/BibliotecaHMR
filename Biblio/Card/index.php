...
function formatManifestationForTrees(manifestation){
	...
	if(manifestation["idType"] == 11){
		result= "<button class='seeManifest' onclick='openManif(this.id);' id='"+manifestation["id"]+"'><i class='fa fa-eye'></i></button>" +
...
<div class="HMR_Footer">
	<script>
		creaFooter(2, "2021", "2021", "E. Lenzi", 
							 "2021/05/23", "2017/10/13 18:15")
	</script> 
</div>
